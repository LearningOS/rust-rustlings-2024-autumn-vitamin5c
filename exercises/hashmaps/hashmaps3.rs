...
fn build_scores_table(results: String) -> HashMap<String, Team> {
    ...
    for r in results.lines() {
        ...
        if scores.contains_key(&team_1_name) {
            let team_1 = Team {goals_scored: scores.get(&team_1_name).unwrap().goals_scored + team_1_score,
        ...
        if scores.contains_key(&team_2_name) {
            let team_2 = Team {goals_scored: scores.get(&team_2_name).unwrap().goals_scored + team_2_score,
